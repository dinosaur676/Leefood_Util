...
const DataInput = ({type, inputData, dataInputHandler}) => {
    const labelList_A = ["파일 명", "id", "상품번호", "주문번호", "받는사람", "전화번호1", "전화번호2", "우편번호", "주소", "상품명1", "상품상세1", "수량(A타입)", "배송메시지", "운임구분", "운임", "운송장번호"]
    const labelList_B = ["파일 명", "id", "상품번호", "주문번호", "보내는사람(지정)", "전화번호1(지정)", "전화번호2(지정)", "우편번호(지정)", "주소(지정)", "받는사람", "전화번호1", "전화번호2", "우편번호", "주소",
        "상품명1", "상품상세1", "수량(A타입)", "배송메시지", "운임구분", "운임", "운송장번호"]
    const labelList_C = ["파일 명", "id", "상품번호", "주문번호","받는사람","전화번호1","전화번호2","우편번호","주소","수량(A타입)","배송메시지","운임구분","운임","운송장번호","상품코드1",
